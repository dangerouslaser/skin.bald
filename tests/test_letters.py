...
class LetterAvailabilityTests(unittest.TestCase):
    ...
    def test_publish_does_not_replace_results_after_leaving_mode(self):
        ...
        xbmc.getCondVisibility.side_effect = lambda condition: condition not in ('Control.IsVisible(511)', 'Control.IsVisible(512)', 'Control.IsVisible(513)', 'Control.IsVisible(514)', 'Control.IsVisible(515)')
        publish(xbmc, gui)
    ...
    def test_wall_container_is_scanned_when_active(self):
        ...
        window.setProperty.side_effect = props.__setitem__
        window.getProperty.side_effect = lambda key: props.get(key, '')
        xbmc.getCondVisibility.side_effect = lambda condition: condition not in ('Control.IsVisible(512)', 'Control.IsVisible(513)', 'Control.IsVisible(514)', 'Control.IsVisible(515)')
        xbmc.getInfoLabel.side_effect = lambda key: {
    ...
    def test_preview_wall_container_is_scanned_when_active(self):
        ...
        window.setProperty.side_effect = props.__setitem__
        window.getProperty.side_effect = lambda key: props.get(key, '')
        xbmc.getCondVisibility.side_effect = lambda condition: condition not in ('Control.IsVisible(513)', 'Control.IsVisible(514)', 'Control.IsVisible(515)')
        xbmc.getInfoLabel.side_effect = lambda key: {
    ...
    def test_compact_list_is_scanned_when_active(self):
        ...
        window.setProperty.side_effect = props.__setitem__
        window.getProperty.side_effect = lambda key: props.get(key, '')
        xbmc.getCondVisibility.side_effect = lambda condition: condition not in ('Control.IsVisible(514)', 'Control.IsVisible(515)')
        xbmc.getInfoLabel.side_effect = lambda key: {
    ...
    def test_artwork_list_is_scanned_when_active(self):
        ...
        window.setProperty.side_effect = props.__setitem__
        window.getProperty.side_effect = lambda key: props.get(key, '')
        xbmc.getCondVisibility.side_effect = lambda condition: condition != 'Control.IsVisible(515)'
        xbmc.getInfoLabel.side_effect = lambda key: {
